...
class RapidROIWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.exclude_left.setValue(min(20, self.lx))
        ...
        self.exclude_right.setValue(min(20, self.lx))
        ...
        self.exclude_top.setValue(min(20, self.ly))
        ...
        self.exclude_bottom.setValue(min(20, self.ly))
