...
SETTINGS = {
    ...
    "detection": {
        ...
        "bright_area_percentile": {
            ...
            "max": 100.,
            "default": 30.,
            "description": "Brightest percentage of the smoothed mean image used to estimate the sparsery peak threshold. Set 0 to use the whole frame.",
        },
        "include_area_percentile": {
            "gui_name": "Include area",
            "type": float,
            "min": 0.,
            "max": 100.,
            "default": 5.,
            "description": "Smoothed mean-image percentile used to define where ROIs are valid. Set 0 to allow the whole frame.",
        },
        "lateral_exclude_percent": {
            "gui_name": "Lateral exclude percent",
            "type": float,
            "min": 0.,
            "max": 50.,
            "default": 5.,
            "description": "Exclude this percentage from both left and right frame edges from peak candidate detection. This does not affect Bright area threshold estimation.",
        },
        "include_min_roi_fraction": {
            "gui_name": "Include ROI fraction",
            "type": float,
            "min": 0.,
            "max": 1.,
            "default": 0.5,
            "description": "Minimum fraction of each ROI footprint that must be inside the Include area mask.",
        },
        "min_roi_pixels": {
            "gui_name": "Min ROI pixels",
            "type": int,
            "min": 0,
            "max": np.inf,
            "default": 0,
            "description": "Hard minimum number of pixels in an ROI footprint. Set 0 to disable.",
        },
        "max_roi_pixels": {
            "gui_name": "Max ROI pixels",
            "type": int,
            "min": 0,
            "max": np.inf,
            "default": 0,
            "description": "Hard maximum number of pixels in an ROI footprint. Set 0 to disable.",
        },
        "min_roi_width": {
            "gui_name": "Min ROI width",
            "type": int,
            "min": 0,
            "max": np.inf,
            "default": 0,
            "description": "Minimum ROI footprint width in pixels. Set 0 to disable.",
        },
        "max_roi_width": {
            "gui_name": "Max ROI width",
            "type": int,
            "min": 0,
            "max": np.inf,
            "default": 0,
            "description": "Maximum ROI footprint width in pixels. Set 0 to disable.",
        },
        "min_roi_height": {
            "gui_name": "Min ROI height",
            "type": int,
            "min": 0,
            "max": np.inf,
            "default": 0,
            "description": "Minimum ROI footprint height in pixels. Set 0 to disable.",
        },
        "max_roi_height": {
            "gui_name": "Max ROI height",
            "type": int,
            "min": 0,
            "max": np.inf,
            "default": 0,
            "description": "Maximum ROI footprint height in pixels. Set 0 to disable.",
        },
        "npix_norm_min": {
        ...
        "sparsery_settings": {
            ...
            "max_peaks_to_check": {
                "gui_name": "Max peaks to check",
                "type": int,
                "min": 1,
                "max": np.inf,
                "default": 20000,
                "description": "Maximum number of sparsery candidate peaks to test while looking for accepted ROIs.",
            },
            "spatial_scale": {
